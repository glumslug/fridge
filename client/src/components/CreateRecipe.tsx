...
type CreateRecipeProps = {
  ...
  setSelectedRecipe: (arg0: recipe) => void;
};
...
const CreateRecipe = ({ setView, setSelectedRecipe }: CreateRecipeProps) => {
  ...
  return (
    <>
      ...
      <Form className="d-flex flex-column w-100">
        ...
        {/* Cuisine */}
        <Form.Group className="mb-3 position-relative" style={{ zIndex: "2" }}>
        ...
        {/* Source */}
        <Form.Group className="mb-3 position-relative" style={{ zIndex: "1" }}>
